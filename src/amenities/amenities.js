	...
	return (
		<div className="MainColumnForAmenities" ref={scrollRef}>
			...
			<div className="column2">
				...
				>
					Experience unparalleled luxury with world-class amenities tailored to elevate your
					lifestyle
				</div>
				<div className="line_dd" style={{ width: "950px", height: "0.8px" }}></div>
				<div style={{ height: "30px" }}></div>

				<div className="rowforAm">
					<img className="planImageAm" src="./drone_view_compressed.jpeg" alt="drone view" />
