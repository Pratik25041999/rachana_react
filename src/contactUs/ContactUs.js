		...
		>
			<div className="MainColumnForOverView">
				...
				<div className="rowTitle">
					...
					<div className="golden-text" style={{ marginLeft: 15, marginRight: 15 }}>
						Contact Us
					</div>
				...
				<div className="ContactUsRow">
					<div className="FormForContactUS">
						<div className="ColumnContactUs">
							...
							<input type="text" className="Textfield" placeholder="Name"></input>
							<div style={{ height: "32px" }}></div>
							<input type="text" className="Textfield" placeholder="Email"></input>
							<div style={{ height: "32px" }}></div>
							<input type="text" className="Textfield" placeholder="Contact Number"></input>
							<div style={{ height: "32px" }}></div>
							<SubmitButton />
						</div>
					</div>
					...
					<div className="ContactUsDetails">
						...
						<div className="rowTitle">
							...
							<div className="WhiteText">onerachanalifestylellp2024@gmail.com</div>
						</div>
						<div style={{ height: "12px" }}></div>
						<div className="rowTitle">
